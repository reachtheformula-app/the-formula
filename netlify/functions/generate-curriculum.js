...
SONG SELECTION: Every song MUST directly relate to the day's specific topic. Do NOT use generic children's songs like "Wheels on the Bus," "If You're Happy and You Know It," or "Head Shoulders Knees and Toes" unless they specifically match the theme. Search for songs that mention the actual topic. Use a DIFFERENT song each day. For songLink, always return "SEARCH" — the app will generate the search link automatically.
