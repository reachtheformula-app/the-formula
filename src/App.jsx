...
const App = () => {
  ...
  // ========== FIVE SENSES TEACHING PHILOSOPHY ==========
  ...
  const weeks = [
    ...
    { id: 39, theme: "Fun with the Five Senses", season: "Any", focus: "Science", ages: ["2-3", "3-4", "4-5"], hasRichData: true, days: fiveSensesDays, activities: { circleTime: "We have five amazing senses!", songOfDay: { title: "Five Senses", link: "youtube.com" }, morningActivity: "Color Mixing (sight)", lunch: "Taste Test", afternoonActivity: "Slime Time (touch)" }},
    ...
    <div className="min-h-screen" style={{backgroundColor: c.cream, fontFamily: 'Quicksand, sans-serif'}}>
      ...
      {view === 'dailyPlan' && (
        <div className="p-4 pb-24">
          ...
          {(currentWeek.id === 46 || currentWeek.id === 1 || currentWeek.id === 2 || currentWeek.id === 3 || currentWeek.id === 20 || currentWeek.id === 24) && (
